...
if __name__ == "__main__":
    input_file = r"F:\2_python\test1024Gout\pythonProject1\.venv\radar_raw_data_10_25_10241747_write_height7_65.bin"   # 输入的大文件
    output_dir = r"F:\2_python\test1024Gout\pythonProject1\.venv\10241747"   # 输出的目录
